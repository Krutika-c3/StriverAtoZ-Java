...
public class UnionArrays {
    ...
    public static ArrayList<Integer> findUnionBrute(int[] arr1, int[] arr2) {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> union1 = findUnionBrute(arr1, arr2);
        System.out.println("Union:   " + union1);

        System.out.println("Optimal Approach: ");
        ArrayList<Integer> union2 = findUnionOptimal(arr1, arr2, arr1.length, arr2.length);

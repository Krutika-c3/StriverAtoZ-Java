...
public class IntersectionArrays {
    ...
    public static ArrayList<Integer> intersectionBrute(int[] arr1, int[] arr2, int n, int m) {
    ...
    public static ArrayList<Integer> intersectionOptimal(int[] arr1, int[] arr2, int n, int m) {
        ArrayList<Integer> ans = new ArrayList<>();
        int i = 0;
        int j = 0;
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> intersection1 = intersectionBrute(arr1, arr2, arr1.length, arr2.length);
        System.out.println("Intersection: " + intersection1);

        System.out.println("Optimal Approach: ");
        ArrayList<Integer> intersection2 = intersectionOptimal(arr1, arr2, arr1.length, arr2.length);
